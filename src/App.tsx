...
function AppContent() {
  ...
  const [customMaxPaths, setCustomMaxPaths] = useState<string>('100');
  const [maxPathsEnabled, setMaxPathsEnabled] = useState(true);
  const [maxDepth, setMaxDepth] = useState<number>(5);
  const [customMaxDepth, setCustomMaxDepth] = useState<string>('5');
            ...
            {currentSection === 'home' && (
              <Suspense fallback={<LoadingSpinner />}>
                <Home
                  ...
                  customMaxPaths={customMaxPaths}
                  setCustomMaxPaths={setCustomMaxPaths}
                  maxPathsEnabled={maxPathsEnabled}
                  setMaxPathsEnabled={setMaxPathsEnabled}
                  maxDepth={maxDepth}
                  setMaxDepth={setMaxDepth}
                  customMaxDepth={customMaxDepth}
                  setCustomMaxDepth={setCustomMaxDepth}
